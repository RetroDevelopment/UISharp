...
/// <summary>
/// The base class represnting a UISharp theme. It contains all fields needed by UISharp default components.
...
public class Theme : ThemeBase
{
    ...
    {
        var allowedBinding = BindingType.SourceToDestination;
