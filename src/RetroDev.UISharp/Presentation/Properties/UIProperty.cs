...
public class UIProperty<TValue>
{
    ...
    public virtual void Bind<TSource>(UIProperty<TSource> sourceProperty, BindingType bindingType, IBindingValueConverter<TSource, TValue> converter)
    {
        ThrowIfSetNotAllowed();
        _binder?.Dispose();
    ...
    /// </param>
    public virtual void Bind(UIProperty<TValue> sourceProperty, BindingType bindingType)
    {
    ...
    public virtual void Bind<TSource>(UIProperty<TSource> sourceProperty,
    ...
    /// the given <paramref name="sourceProperty" /> is the source property.
    /// </param>
    public virtual void BindDestinationToSource(UIProperty<TValue> sourceProperty)
    {
    ...
    public virtual void BindDestinationToSource<TSource>(UIProperty<TSource> sourceProperty,
                                                         Func<TSource, TValue> sourceToDestinationConverter)
    {
    ...
    /// the given <paramref name="sourceProperty" /> is the source property.
    /// </param>
    public virtual void BindSourceToDestination(UIProperty<TValue> sourceProperty)
    {
    ...
    /// <param name="sourceProperty">The source property to bind.</param>
    /// <param name="sourceToDestinationConverter">The function converting from source property value to source property value.</param>
    public virtual void BindSourceToDestination<TSource>(UIProperty<TSource> sourceProperty,
                                                         Func<TSource, TValue> sourceToDestinationConverter)
    {
    ...
    /// </param>
    public virtual void BindTwoWays(UIProperty<TValue> sourceProperty)
    {
    ...
    /// <param name="sourceToDestinationConverter">The function converting from source property value to destination property value.</param>
    /// <param name="destinationToSourceConverter">The function converting from destination property value to source property value.</param>
    public virtual void BindTwoWays<TSource>(UIProperty<TSource> sourceProperty,
                                             Func<TSource, TValue> sourceToDestinationConverter,
                                             Func<TValue, TSource> destinationToSourceConverter)
    {
