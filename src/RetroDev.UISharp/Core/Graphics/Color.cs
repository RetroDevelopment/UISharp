...
namespace RetroDev.UISharp.Core.Graphics;
...
public readonly record struct Color(byte RedComponent = 0, byte GreenComponent = 0, byte BlueComponent = 0, byte AlphaComponent = 0)
{
    ...
    /// The color hexadecimal represnetation in the form #RRGGBBAA (case insensitive), or a color constant defined in the <see cref="Color"/> class (e.g. <see cref="Red")/>.
