...
{
    /// <summary>
    /// The list of logical children of a container. Note that this differs from <see cref="UIObject.Children"/> which is the
    /// list of actual children in the UI tree view.
    /// </summary>
    /// <example>
    /// A layout <see cref="UIObject.Children"/> may be a list of panels containing wrapping labels plus additional decorator components.
    ...
    /// </remarks>
    UIPropertyCollection<UIControl> Items { get; }
}
