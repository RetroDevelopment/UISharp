...
/// </summary>
/// <remarks>
/// When implementing a new <see cref="UIOverlay"/> you should consider the following:
...
public abstract class UIOverlay : UIElement
{
    ...
    protected UIOverlay(Application application, ComponentVisibility visibility = ComponentVisibility.Hidden, bool isFocusable = false, IAutoSize? autoWidth = null, IAutoSize? autoHeight = null, IHorizontalAlignment? horizontalAlignment = null, IVerticalAlignment? verticalAlignment = null) : base(application, visibility, isFocusable, autoWidth ?? AutoSize.Wrap, autoHeight ?? AutoSize.Wrap, horizontalAlignment, verticalAlignment)
    {
    }
}
