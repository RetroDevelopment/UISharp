...
public abstract class UIRoot : UIComponent, IContainer
{
    ...
    private void UIRoot_MouseMove(UIComponent sender, UISharp.Core.Windowing.Events.MouseEventArgs e)
    {
    ...
    private void UIRoot_MouseRelease(UIComponent sender, UISharp.Core.Windowing.Events.MouseEventArgs e)
    {
